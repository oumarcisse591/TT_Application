...
public class ClientDaoImpl implements ClientDao{
    ...
    public List<Client> findAllClient() {
        TypedQuery<Client> theQuery = entityManager.createQuery("SELECT c FROM Client c ORDER BY c.id DESC", Client.class);
    ...
    public Long getClientCount() {
        Query theQuery = entityManager.createQuery("SELECT COUNT(*) FROM Client", Client.class);
