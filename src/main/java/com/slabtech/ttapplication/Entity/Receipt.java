package com.slabtech.ttapplication.Entity;
...
public class Receipt {
    ...
    public Receipt(String receiptCode, String swift_code, Date receiptDate, Date valueDate, double amount, String currency, String beneficiaryBank, String beneficiaryAccount, String remitterBank, String remitterAccount, String motifTransaction, Client client, Society society, Beneficiary beneficiary) {
    ...
    public Receipt(int id, String receiptCode, String swift_code, Date receiptDate, Date valueDate, double amount, String currency, String beneficiaryBank, String beneficiaryAccount, String remitterBank, String remitterAccount, String motifTransaction, Client client, Society society, Beneficiary beneficiary) {
        this.id = id;
        this.receiptCode = receiptCode;
        this.swift_code = swift_code;
        this.receiptDate = receiptDate;
